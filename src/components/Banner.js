    ...
    <section className='min-h-[600px] pt-24 pb-12 text-center relative lg:pt-48 lg:pb-0 lg:text-left'>
      <div className='container mx-auto'>
        <div className='flex flex-col lg:flex-row'>
          ...
          data-aos='fade-down' data-aos-delay='500'>Let's Explore <br/> Three-Dimensional Visually.</h1>
          <p className='font-secondary mb-12 max-w-[440px] mx-auto lg:mx-0'
          data-aos='fade-down' data-aos-delay='600'>Service that provides the best quality and at 
